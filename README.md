...
<body>
  <script>
    ...
    var defs = {}
        defs["models.Comment"] = {"type":"object","properties":{"created_at":{"type":"string"},"id":{"type":"integer"},"message":{"type":"string"},"photo":{"$ref":"#/definitions/models.Photo"},"photoID":{"type":"integer"},"updated_at":{"type":"string"},"user":{"$ref":"#/definitions/models.User"},"userID":{"type":"integer"}}};
        defs["models.Photo"] = {"type":"object","required":["caption"],"properties":{"caption":{"type":"string"},"created_at":{"type":"string"},"id":{"type":"integer"},"photo_url":{"type":"string"},"title":{"type":"string"},"updated_at":{"type":"string"},"user":{"$ref":"#/definitions/models.User"},"userID":{"type":"integer"}}};
        defs["models.SocialMedia"] = {"type":"object","properties":{"created_at":{"type":"string"},"id":{"type":"integer"},"name":{"type":"string"},"social_media_url":{"type":"string"},"updated_at":{"type":"string"},"user":{"$ref":"#/definitions/models.User"},"userID":{"type":"integer"}}};
        defs["models.User"] = {"type":"object","required":["age"],"properties":{"age":{"type":"integer","minimum":9},"comments":{"type":"array","items":{"$ref":"#/definitions/models.Comment"}},"created_at":{"type":"string"},"email":{"type":"string"},"id":{"type":"integer"},"password":{"type":"string"},"photos":{"type":"array","items":{"$ref":"#/definitions/models.Photo"}},"social_medias":{"type":"array","items":{"$ref":"#/definitions/models.SocialMedia"}},"updated_at":{"type":"string"},"username":{"type":"string"}}};
  </script>
        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Comments"><a href="#api-Comments">API Methods - Comments</a></li>
                    <li data-group="Comments" data-name="commentsCommentIdDelete" class="">
                      <a href="#api-Comments-commentsCommentIdDelete">commentsCommentIdDelete</a>
                    </li>
                    <li data-group="Comments" data-name="commentsCommentIdGet" class="">
                      <a href="#api-Comments-commentsCommentIdGet">commentsCommentIdGet</a>
                    </li>
                    <li data-group="Comments" data-name="commentsCommentIdPut" class="">
                      <a href="#api-Comments-commentsCommentIdPut">commentsCommentIdPut</a>
                    </li>
                    <li data-group="Comments" data-name="photosPhotoIdCommentsGet" class="">
                      <a href="#api-Comments-photosPhotoIdCommentsGet">photosPhotoIdCommentsGet</a>
                    </li>
                    <li data-group="Comments" data-name="photosPhotoIdCommentsPost" class="">
                      <a href="#api-Comments-photosPhotoIdCommentsPost">photosPhotoIdCommentsPost</a>
                    </li>
                  <li class="nav-header" data-group="Photos"><a href="#api-Photos">API Methods - Photos</a></li>
                    <li data-group="Photos" data-name="photosGet" class="">
                      <a href="#api-Photos-photosGet">photosGet</a>
                    </li>
                    <li data-group="Photos" data-name="photosIdDelete" class="">
                      <a href="#api-Photos-photosIdDelete">photosIdDelete</a>
                    </li>
                    <li data-group="Photos" data-name="photosIdGet" class="">
                      <a href="#api-Photos-photosIdGet">photosIdGet</a>
                    </li>
                    <li data-group="Photos" data-name="photosIdPut" class="">
                      <a href="#api-Photos-photosIdPut">photosIdPut</a>
                    </li>
                    <li data-group="Photos" data-name="photosPost" class="">
                      <a href="#api-Photos-photosPost">photosPost</a>
                    </li>
                  <li class="nav-header" data-group="SocialMedia"><a href="#api-SocialMedia">API Methods - SocialMedia</a></li>
                    <li data-group="SocialMedia" data-name="deleteSocmed" class="">
                      <a href="#api-SocialMedia-deleteSocmed">deleteSocmed</a>
                    </li>
                    <li data-group="SocialMedia" data-name="socmedsGet" class="">
                      <a href="#api-SocialMedia-socmedsGet">socmedsGet</a>
                    </li>
                    <li data-group="SocialMedia" data-name="socmedsPost" class="">
                      <a href="#api-SocialMedia-socmedsPost">socmedsPost</a>
                    </li>
                    <li data-group="SocialMedia" data-name="socmedsSocmedIdGet" class="">
                      <a href="#api-SocialMedia-socmedsSocmedIdGet">socmedsSocmedIdGet</a>
                    </li>
                    <li data-group="SocialMedia" data-name="updateSocmed" class="">
                      <a href="#api-SocialMedia-updateSocmed">updateSocmed</a>
                    </li>
                  <li class="nav-header" data-group="Users"><a href="#api-Users">API Methods - Users</a></li>
                    <li data-group="Users" data-name="usersLoginPost" class="">
                      <a href="#api-Users-usersLoginPost">usersLoginPost</a>
                    </li>
                    <li data-group="Users" data-name="usersRegisterPost" class="">
                      <a href="#api-Users-usersRegisterPost">usersRegisterPost</a>
                    </li>
          </ul>
        </nav>
      </div>
        ...
        <div id="header">
          <div id="api-_">
            <h2 id="welcome-to-apidoc">API and SDK Documentation</h2>
              <div class="app-desc">Version: 1</div>
            <hr>
            <div>This is a sample API for MyGram application</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Comments">
                  <h1>Comments</h1>
                    <div id="api-Comments-commentsCommentIdDelete">
                      <article id="api-Comments-commentsCommentIdDelete-0" data-group="User" data-name="commentsCommentIdDelete" data-version="0">
                        <div class="pull-left">
                          <h1>commentsCommentIdDelete</h1>
                          <p>Delete a comment</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Delete a comment</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/comments/{commentId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Comments-commentsCommentIdDelete-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-java">Java</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdDelete-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Comments-commentsCommentIdDelete-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://localhost:8080/api/v1/comments/{commentId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-java">
...
public class CommentsApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorization = authorization_example; // String | JWT Token
        Integer commentId = 56; // Integer | Comment ID
        try {
            models.Comment result = apiInstance.commentsCommentIdDelete(authorization, commentId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CommentsApi#commentsCommentIdDelete");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *commentId = 56; // Comment ID

CommentsApi *apiInstance = [[CommentsApi alloc] init];

// Delete a comment
[apiInstance commentsCommentIdDeleteWith:authorization
    commentId:commentId
              completionHandler: ^(models.Comment output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');

var api = new MyGramApi.CommentsApi()

var authorization = authorization_example; // {String} JWT Token

var commentId = 56; // {Integer} Comment ID
...
api.commentsCommentIdDelete(authorization, commentId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-csharp">
...
namespace Example
{
    public class commentsCommentIdDeleteExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CommentsApi.commentsCommentIdDelete: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\CommentsApi();
$authorization = authorization_example; // String | JWT Token
$commentId = 56; // Integer | Comment ID

try {
    $result = $api_instance->commentsCommentIdDelete($authorization, $commentId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CommentsApi->commentsCommentIdDelete: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::CommentsApi;

my $api_instance = WWW::SwaggerClient::CommentsApi->new();
my $authorization = authorization_example; # String | JWT Token
my $commentId = 56; # Integer | Comment ID

eval { 
    my $result = $api_instance->commentsCommentIdDelete(authorization => $authorization, commentId => $commentId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CommentsApi->commentsCommentIdDelete: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-commentsCommentIdDelete-0-python">
...
try: 
    # Delete a comment
    api_response = api_instance.comments_comment_id_delete(authorization, commentId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CommentsApi->commentsCommentIdDelete: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">commentId*</td>
<td>


    <div id="d2e199_commentsCommentIdDelete_commentId">
...
<td>
    ...
    <div id="d2e199_commentsCommentIdDelete_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-commentsCommentIdDelete-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-commentsCommentIdDelete-200-schema">
                                  <div id='responses-commentsCommentIdDelete-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Comment"
                                        ...
                                        $('#responses-commentsCommentIdDelete-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-commentsCommentIdDelete-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-commentsCommentIdDelete-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>

                            <h3> Status: 400 - Bad Request </h3>
                      ...
                      <hr>
                    <div id="api-Comments-commentsCommentIdGet">
                      <article id="api-Comments-commentsCommentIdGet-0" data-group="User" data-name="commentsCommentIdGet" data-version="0">
                        <div class="pull-left">
                          <h1>commentsCommentIdGet</h1>
                          <p>Get a comment by ID</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Get a comment by ID</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/comments/{commentId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Comments-commentsCommentIdGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Comments-commentsCommentIdGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Comments-commentsCommentIdGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Comments-commentsCommentIdGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://localhost:8080/api/v1/comments/{commentId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
    ...
    public static void main(String[] args) {
        ...
        Integer commentId = 56; // Integer | Comment ID
        try {
            models.Comment result = apiInstance.commentsCommentIdGet(authorization, commentId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CommentsApi#commentsCommentIdGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *commentId = 56; // Comment ID
...
// Get a comment by ID
[apiInstance commentsCommentIdGetWith:authorization
    commentId:commentId
              completionHandler: ^(models.Comment output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.commentsCommentIdGet(authorization, commentId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class commentsCommentIdGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CommentsApi.commentsCommentIdGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->commentsCommentIdGet($authorization, $commentId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CommentsApi->commentsCommentIdGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::CommentsApi;
...
eval { 
    my $result = $api_instance->commentsCommentIdGet(authorization => $authorization, commentId => $commentId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CommentsApi->commentsCommentIdGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-commentsCommentIdGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get a comment by ID
    api_response = api_instance.comments_comment_id_get(authorization, commentId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CommentsApi->commentsCommentIdGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_commentsCommentIdGet_commentId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_commentsCommentIdGet_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-commentsCommentIdGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-commentsCommentIdGet-200-schema">
                                  <div id='responses-commentsCommentIdGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Comment"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-commentsCommentIdGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-commentsCommentIdGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-commentsCommentIdGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Comments-commentsCommentIdPut">
                      <article id="api-Comments-commentsCommentIdPut-0" data-group="User" data-name="commentsCommentIdPut" data-version="0">
                        <div class="pull-left">
                          <h1>commentsCommentIdPut</h1>
                          <p>Update a comment</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Update a comment</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/comments/{commentId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Comments-commentsCommentIdPut-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-java">Java</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Comments-commentsCommentIdPut-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Comments-commentsCommentIdPut-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Comments-commentsCommentIdPut-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Comments-commentsCommentIdPut-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://localhost:8080/api/v1/comments/{commentId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorization = authorization_example; // String | JWT Token
        Integer commentId = 56; // Integer | Comment ID
        Models.Comment comment = ; // Models.Comment | Comment
        try {
            models.Comment result = apiInstance.commentsCommentIdPut(authorization, commentId, comment);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CommentsApi#commentsCommentIdPut");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *commentId = 56; // Comment ID
...
// Update a comment
[apiInstance commentsCommentIdPutWith:authorization
    commentId:commentId
    comment:comment
              completionHandler: ^(models.Comment output, NSError* error) {
                            if (output) {
                            ...
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.commentsCommentIdPut(authorization, commentId, comment, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class commentsCommentIdPutExample
    {
        public void main()
        {
            ...
            var authorization = authorization_example;  // String | JWT Token
            var commentId = 56;  // Integer | Comment ID
            var comment = new Models.Comment(); // Models.Comment | Comment
            ...
            {
                Debug.Print("Exception when calling CommentsApi.commentsCommentIdPut: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->commentsCommentIdPut($authorization, $commentId, $comment);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CommentsApi->commentsCommentIdPut: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::CommentsApi;
...
my $authorization = authorization_example; # String | JWT Token
my $commentId = 56; # Integer | Comment ID
my $comment = WWW::SwaggerClient::Object::Models.Comment->new(); # Models.Comment | Comment

eval { 
    my $result = $api_instance->commentsCommentIdPut(authorization => $authorization, commentId => $commentId, comment => $comment);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CommentsApi->commentsCommentIdPut: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-commentsCommentIdPut-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Update a comment
    api_response = api_instance.comments_comment_id_put(authorization, commentId, comment)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CommentsApi->commentsCommentIdPut: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_commentsCommentIdPut_commentId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_commentsCommentIdPut_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">comment <span style="color:red;">*</span></td>
<td>
...
$(document).ready(function() {
  ...
  var result = $('#d2e199_commentsCommentIdPut_comment');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_commentsCommentIdPut_comment"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-commentsCommentIdPut-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-commentsCommentIdPut-200-schema">
                                  <div id='responses-commentsCommentIdPut-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Comment"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-commentsCommentIdPut-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-commentsCommentIdPut-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-commentsCommentIdPut-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Comments-photosPhotoIdCommentsGet">
                      <article id="api-Comments-photosPhotoIdCommentsGet-0" data-group="User" data-name="photosPhotoIdCommentsGet" data-version="0">
                        <div class="pull-left">
                          <h1>photosPhotoIdCommentsGet</h1>
                          <p>Get all comments for a photo</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Get all comments for a photo</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/photos/{photoId}/comments</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Comments-photosPhotoIdCommentsGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Comments-photosPhotoIdCommentsGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://localhost:8080/api/v1/photos/{photoId}/comments"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
    ...
    public static void main(String[] args) {
        ...
        CommentsApi apiInstance = new CommentsApi();
        String authorization = authorization_example; // String | JWT Token
        Integer photoId = 56; // Integer | Photo ID
        try {
            models.Comment result = apiInstance.photosPhotoIdCommentsGet(authorization, photoId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CommentsApi#photosPhotoIdCommentsGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *photoId = 56; // Photo ID

CommentsApi *apiInstance = [[CommentsApi alloc] init];

// Get all comments for a photo
[apiInstance photosPhotoIdCommentsGetWith:authorization
    photoId:photoId
              completionHandler: ^(models.Comment output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
var photoId = 56; // {Integer} Photo ID
...
api.photosPhotoIdCommentsGet(authorization, photoId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class photosPhotoIdCommentsGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CommentsApi.photosPhotoIdCommentsGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\CommentsApi();
$authorization = authorization_example; // String | JWT Token
$photoId = 56; // Integer | Photo ID

try {
    $result = $api_instance->photosPhotoIdCommentsGet($authorization, $photoId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CommentsApi->photosPhotoIdCommentsGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::CommentsApi;
...
my $api_instance = WWW::SwaggerClient::CommentsApi->new();
my $authorization = authorization_example; # String | JWT Token
my $photoId = 56; # Integer | Photo ID

eval { 
    my $result = $api_instance->photosPhotoIdCommentsGet(authorization => $authorization, photoId => $photoId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CommentsApi->photosPhotoIdCommentsGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get all comments for a photo
    api_response = api_instance.photos_photo_id_comments_get(authorization, photoId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CommentsApi->photosPhotoIdCommentsGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">photoId*</td>
<td>


    <div id="d2e199_photosPhotoIdCommentsGet_photoId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_photosPhotoIdCommentsGet_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-photosPhotoIdCommentsGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-photosPhotoIdCommentsGet-200-schema">
                                  <div id='responses-photosPhotoIdCommentsGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Comment"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-photosPhotoIdCommentsGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-photosPhotoIdCommentsGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-photosPhotoIdCommentsGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Comments-photosPhotoIdCommentsPost">
                      <article id="api-Comments-photosPhotoIdCommentsPost-0" data-group="User" data-name="photosPhotoIdCommentsPost" data-version="0">
                        <div class="pull-left">
                          <h1>photosPhotoIdCommentsPost</h1>
                          <p>Create a new comment</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Create a new comment</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/photos/{photoId}/comments</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Comments-photosPhotoIdCommentsPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Comments-photosPhotoIdCommentsPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Comments-photosPhotoIdCommentsPost-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://localhost:8080/api/v1/photos/{photoId}/comments"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
    ...
    public static void main(String[] args) {
        ...
        Models.Comment comment = ; // Models.Comment | Comment
        try {
            models.Comment result = apiInstance.photosPhotoIdCommentsPost(authorization, photoId, comment);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling CommentsApi#photosPhotoIdCommentsPost");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.CommentsApi;
...
public class CommentsApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *photoId = 56; // Photo ID
Models.Comment *comment = ; // Comment
...
[apiInstance photosPhotoIdCommentsPostWith:authorization
    photoId:photoId
    comment:comment
              completionHandler: ^(models.Comment output, NSError* error) {
                            if (output) {
                            ...
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.photosPhotoIdCommentsPost(authorization, photoId, comment, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class photosPhotoIdCommentsPostExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling CommentsApi.photosPhotoIdCommentsPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->photosPhotoIdCommentsPost($authorization, $photoId, $comment);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CommentsApi->photosPhotoIdCommentsPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::CommentsApi;
...
eval { 
    my $result = $api_instance->photosPhotoIdCommentsPost(authorization => $authorization, photoId => $photoId, comment => $comment);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling CommentsApi->photosPhotoIdCommentsPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Comments-photosPhotoIdCommentsPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Create a new comment
    api_response = api_instance.photos_photo_id_comments_post(authorization, photoId, comment)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CommentsApi->photosPhotoIdCommentsPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_photosPhotoIdCommentsPost_photoId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_photosPhotoIdCommentsPost_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_photosPhotoIdCommentsPost_comment');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_photosPhotoIdCommentsPost_comment"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-photosPhotoIdCommentsPost-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-photosPhotoIdCommentsPost-200-schema">
                                  <div id='responses-photosPhotoIdCommentsPost-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Comment"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-photosPhotoIdCommentsPost-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-photosPhotoIdCommentsPost-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-photosPhotoIdCommentsPost-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-Photos">
                  <h1>Photos</h1>
                    <div id="api-Photos-photosGet">
                      <article id="api-Photos-photosGet-0" data-group="User" data-name="photosGet" data-version="0">
                        <div class="pull-left">
                          <h1>photosGet</h1>
                          <p>Get all photos</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Get all photos</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/photos</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Photos-photosGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Photos-photosGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Photos-photosGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Photos-photosGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Photos-photosGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Photos-photosGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Photos-photosGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Photos-photosGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Photos-photosGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Photos-photosGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://localhost:8080/api/v1/photos"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Photos-photosGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
...
public class PhotosApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorization = authorization_example; // String | JWT Token
        try {
            models.Photo result = apiInstance.photosGet(authorization);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PhotosApi#photosGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Photos-photosGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Photos-photosGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Photos-photosGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token

PhotosApi *apiInstance = [[PhotosApi alloc] init];

// Get all photos
[apiInstance photosGetWith:authorization
              completionHandler: ^(models.Photo output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-Photos-photosGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');

var api = new MyGramApi.PhotosApi()
...
api.photosGet(authorization, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Photos-photosGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Photos-photosGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class photosGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PhotosApi.photosGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Photos-photosGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->photosGet($authorization);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PhotosApi->photosGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
eval { 
    my $result = $api_instance->photosGet(authorization => $authorization);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PhotosApi->photosGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get all photos
    api_response = api_instance.photos_get(authorization)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PhotosApi->photosGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_photosGet_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-photosGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-photosGet-200-schema">
                                  <div id='responses-photosGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Photo"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-photosGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-photosGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-photosGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Photos-photosIdDelete">
                      <article id="api-Photos-photosIdDelete-0" data-group="User" data-name="photosIdDelete" data-version="0">
                        <div class="pull-left">
                          <h1>photosIdDelete</h1>
                          <p>Delete a photo by id</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Delete a photo by id</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/photos/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Photos-photosIdDelete-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-java">Java</a></li>
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosIdDelete-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosIdDelete-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Photos-photosIdDelete-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Photos-photosIdDelete-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://localhost:8080/api/v1/photos/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Photos-photosIdDelete-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
    ...
    public static void main(String[] args) {
        ...
        PhotosApi apiInstance = new PhotosApi();
        String authorization = authorization_example; // String | JWT Token
        Integer id = 56; // Integer | Photo ID
        try {
            models.Photo result = apiInstance.photosIdDelete(authorization, id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PhotosApi#photosIdDelete");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Photos-photosIdDelete-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Photos-photosIdDelete-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Photos-photosIdDelete-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *id = 56; // Photo ID

PhotosApi *apiInstance = [[PhotosApi alloc] init];

// Delete a photo by id
[apiInstance photosIdDeleteWith:authorization
    id:id
              completionHandler: ^(models.Photo output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Photos-photosIdDelete-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.photosIdDelete(authorization, id, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Photos-photosIdDelete-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Photos-photosIdDelete-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class photosIdDeleteExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PhotosApi.photosIdDelete: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Photos-photosIdDelete-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\PhotosApi();
$authorization = authorization_example; // String | JWT Token
$id = 56; // Integer | Photo ID

try {
    $result = $api_instance->photosIdDelete($authorization, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PhotosApi->photosIdDelete: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosIdDelete-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::PhotosApi;
...
my $api_instance = WWW::SwaggerClient::PhotosApi->new();
my $authorization = authorization_example; # String | JWT Token
my $id = 56; # Integer | Photo ID

eval { 
    my $result = $api_instance->photosIdDelete(authorization => $authorization, id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PhotosApi->photosIdDelete: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosIdDelete-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Delete a photo by id
    api_response = api_instance.photos_id_delete(authorization, id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PhotosApi->photosIdDelete: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_photosIdDelete_id">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_photosIdDelete_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-photosIdDelete-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-photosIdDelete-200-schema">
                                  <div id='responses-photosIdDelete-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Photo"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-photosIdDelete-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-photosIdDelete-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-photosIdDelete-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Photos-photosIdGet">
                      <article id="api-Photos-photosIdGet-0" data-group="User" data-name="photosIdGet" data-version="0">
                        <div class="pull-left">
                          <h1>photosIdGet</h1>
                          <p>Get a photo by id</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Get a photo by id</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/photos/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Photos-photosIdGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Photos-photosIdGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Photos-photosIdGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosIdGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Photos-photosIdGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Photos-photosIdGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosIdGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Photos-photosIdGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Photos-photosIdGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Photos-photosIdGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Photos-photosIdGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Photos-photosIdGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://localhost:8080/api/v1/photos/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Photos-photosIdGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
    ...
    public static void main(String[] args) {
        ...
        Integer id = 56; // Integer | Photo ID
        try {
            models.Photo result = apiInstance.photosIdGet(authorization, id);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PhotosApi#photosIdGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Photos-photosIdGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Photos-photosIdGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Photos-photosIdGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *id = 56; // Photo ID
...
// Get a photo by id
[apiInstance photosIdGetWith:authorization
    id:id
              completionHandler: ^(models.Photo output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Photos-photosIdGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.photosIdGet(authorization, id, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Photos-photosIdGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Photos-photosIdGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class photosIdGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PhotosApi.photosIdGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Photos-photosIdGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->photosIdGet($authorization, $id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PhotosApi->photosIdGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosIdGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::PhotosApi;
...
eval { 
    my $result = $api_instance->photosIdGet(authorization => $authorization, id => $id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PhotosApi->photosIdGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosIdGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get a photo by id
    api_response = api_instance.photos_id_get(authorization, id)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PhotosApi->photosIdGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_photosIdGet_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-photosIdGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-photosIdGet-200-schema">
                                  <div id='responses-photosIdGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Photo"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-photosIdGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-photosIdGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-photosIdGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Photos-photosIdPut">
                      <article id="api-Photos-photosIdPut-0" data-group="User" data-name="photosIdPut" data-version="0">
                        <div class="pull-left">
                          <h1>photosIdPut</h1>
                          <p>Update a photo</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Update a photo</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/photos/{id}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Photos-photosIdPut-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Photos-photosIdPut-0-java">Java</a></li>
                          <li class=""><a href="#examples-Photos-photosIdPut-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosIdPut-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Photos-photosIdPut-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Photos-photosIdPut-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosIdPut-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Photos-photosIdPut-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Photos-photosIdPut-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Photos-photosIdPut-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Photos-photosIdPut-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Photos-photosIdPut-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://localhost:8080/api/v1/photos/{id}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Photos-photosIdPut-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorization = authorization_example; // String | JWT Token
        Integer id = 56; // Integer | Photo ID
        Models.Photo photo = ; // Models.Photo | Photo
        try {
            models.Photo result = apiInstance.photosIdPut(authorization, id, photo);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PhotosApi#photosIdPut");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Photos-photosIdPut-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Photos-photosIdPut-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Photos-photosIdPut-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *id = 56; // Photo ID
Models.Photo *photo = ; // Photo

PhotosApi *apiInstance = [[PhotosApi alloc] init];

// Update a photo
[apiInstance photosIdPutWith:authorization
    id:id
    photo:photo
              completionHandler: ^(models.Photo output, NSError* error) {
                            if (output) {
                            ...
                            <div class="tab-pane" id="examples-Photos-photosIdPut-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.photosIdPut(authorization, id, photo, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Photos-photosIdPut-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Photos-photosIdPut-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class photosIdPutExample
    {
        public void main()
        {
            ...
            var authorization = authorization_example;  // String | JWT Token
            var id = 56;  // Integer | Photo ID
            var photo = new Models.Photo(); // Models.Photo | Photo
            ...
            {
                Debug.Print("Exception when calling PhotosApi.photosIdPut: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Photos-photosIdPut-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->photosIdPut($authorization, $id, $photo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PhotosApi->photosIdPut: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosIdPut-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::PhotosApi;
...
my $authorization = authorization_example; # String | JWT Token
my $id = 56; # Integer | Photo ID
my $photo = WWW::SwaggerClient::Object::Models.Photo->new(); # Models.Photo | Photo

eval { 
    my $result = $api_instance->photosIdPut(authorization => $authorization, id => $id, photo => $photo);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PhotosApi->photosIdPut: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosIdPut-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Update a photo
    api_response = api_instance.photos_id_put(authorization, id, photo)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PhotosApi->photosIdPut: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_photosIdPut_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">photo <span style="color:red;">*</span></td>
<td>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_photosIdPut_photo');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_photosIdPut_photo"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-photosIdPut-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-photosIdPut-200-schema">
                                  <div id='responses-photosIdPut-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Photo"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-photosIdPut-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-photosIdPut-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-photosIdPut-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Photos-photosPost">
                      <article id="api-Photos-photosPost-0" data-group="User" data-name="photosPost" data-version="0">
                        <div class="pull-left">
                          <h1>photosPost</h1>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Create a new photo</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/photos</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Photos-photosPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Photos-photosPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Photos-photosPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Photos-photosPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Photos-photosPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Photos-photosPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Photos-photosPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Photos-photosPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Photos-photosPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Photos-photosPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Photos-photosPost-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://localhost:8080/api/v1/photos"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Photos-photosPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
    ...
    public static void main(String[] args) {
        ...
        Models.Photo photo = ; // Models.Photo | Photo
        try {
            models.Photo result = apiInstance.photosPost(authorization, photo);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling PhotosApi#photosPost");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Photos-photosPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.PhotosApi;
...
public class PhotosApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Photos-photosPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Photos-photosPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Models.Photo *photo = ; // Photo
...
// Create a new photo
[apiInstance photosPostWith:authorization
    photo:photo
              completionHandler: ^(models.Photo output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            ...
                            <div class="tab-pane" id="examples-Photos-photosPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.photosPost(authorization, photo, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Photos-photosPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Photos-photosPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class photosPostExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling PhotosApi.photosPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Photos-photosPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $result = $api_instance->photosPost($authorization, $photo);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling PhotosApi->photosPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::PhotosApi;
...
eval { 
    my $result = $api_instance->photosPost(authorization => $authorization, photo => $photo);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling PhotosApi->photosPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Photos-photosPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Create a new photo
    api_response = api_instance.photos_post(authorization, photo)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling PhotosApi->photosPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_photosPost_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_photosPost_photo');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_photosPost_photo"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-photosPost-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-photosPost-200-schema">
                                  <div id='responses-photosPost-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.Photo"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-photosPost-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-photosPost-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-photosPost-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-SocialMedia">
                  <h1>SocialMedia</h1>
                    <div id="api-SocialMedia-deleteSocmed">
                      <article id="api-SocialMedia-deleteSocmed-0" data-group="User" data-name="deleteSocmed" data-version="0">
                        <div class="pull-left">
                          <h1>deleteSocmed</h1>
                          <p>Delete a social media profile</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Delete a social media profile for the authenticated user</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/socmeds/{socmedId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SocialMedia-deleteSocmed-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-java">Java</a></li>
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-deleteSocmed-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-deleteSocmed-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SocialMedia-deleteSocmed-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SocialMedia-deleteSocmed-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X DELETE "https://localhost:8080/api/v1/socmeds/{socmedId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SocialMediaApi;

import java.io.File;
import java.util.*;

public class SocialMediaApiExample {

    public static void main(String[] args) {
        
        SocialMediaApi apiInstance = new SocialMediaApi();
        Integer socmedId = 56; // Integer | Social media profile ID
        try {
            apiInstance.deleteSocmed(socmedId);
        } catch (ApiException e) {
            System.err.println("Exception when calling SocialMediaApi#deleteSocmed");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *socmedId = 56; // Social media profile ID

SocialMediaApi *apiInstance = [[SocialMediaApi alloc] init];

// Delete a social media profile
[apiInstance deleteSocmedWith:socmedId
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');

var api = new MyGramApi.SocialMediaApi()

var socmedId = 56; // {Integer} Social media profile ID
...
api.deleteSocmed(socmedId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class deleteSocmedExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling SocialMediaApi.deleteSocmed: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\SocialMediaApi();
$socmedId = 56; // Integer | Social media profile ID

try {
    $api_instance->deleteSocmed($socmedId);
} catch (Exception $e) {
    echo 'Exception when calling SocialMediaApi->deleteSocmed: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SocialMediaApi;

my $api_instance = WWW::SwaggerClient::SocialMediaApi->new();
my $socmedId = 56; # Integer | Social media profile ID

eval { 
    $api_instance->deleteSocmed(socmedId => $socmedId);
};
if ($@) {
    warn "Exception when calling SocialMediaApi->deleteSocmed: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-deleteSocmed-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Delete a social media profile
    api_instance.delete_socmed(socmedId)
except ApiException as e:
    print("Exception when calling SocialMediaApi->deleteSocmed: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">socmedId*</td>
<td>


    <div id="d2e199_deleteSocmed_socmedId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
                ...
                <div class="inner required">
                    Required
                      ...
                      <hr>
                    <div id="api-SocialMedia-socmedsGet">
                      <article id="api-SocialMedia-socmedsGet-0" data-group="User" data-name="socmedsGet" data-version="0">
                        <div class="pull-left">
                          <h1>socmedsGet</h1>
                          <p>Get all social media accounts</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/socmeds</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SocialMedia-socmedsGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-socmedsGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-socmedsGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SocialMedia-socmedsGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://localhost:8080/api/v1/socmeds"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
    ...
    public static void main(String[] args) {
        ...
        String authorization = authorization_example; // String | JWT Token
        try {
            apiInstance.socmedsGet(authorization);
        } catch (ApiException e) {
            System.err.println("Exception when calling SocialMediaApi#socmedsGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token

SocialMediaApi *apiInstance = [[SocialMediaApi alloc] init];

// Get all social media accounts
[apiInstance socmedsGetWith:authorization
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.socmedsGet(authorization, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class socmedsGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling SocialMediaApi.socmedsGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $api_instance->socmedsGet($authorization);
} catch (Exception $e) {
    echo 'Exception when calling SocialMediaApi->socmedsGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SocialMediaApi;
...
eval { 
    $api_instance->socmedsGet(authorization => $authorization);
};
if ($@) {
    warn "Exception when calling SocialMediaApi->socmedsGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-socmedsGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get all social media accounts
    api_instance.socmeds_get(authorization)
except ApiException as e:
    print("Exception when calling SocialMediaApi->socmedsGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_socmedsGet_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                      ...
                      <hr>
                    <div id="api-SocialMedia-socmedsPost">
                      <article id="api-SocialMedia-socmedsPost-0" data-group="User" data-name="socmedsPost" data-version="0">
                        <div class="pull-left">
                          <h1>socmedsPost</h1>
                          <p>Create a new social media account</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/socmeds</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SocialMedia-socmedsPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-socmedsPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-socmedsPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SocialMedia-socmedsPost-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://localhost:8080/api/v1/socmeds"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
    ...
    public static void main(String[] args) {
        ...
        SocialMediaApi apiInstance = new SocialMediaApi();
        String authorization = authorization_example; // String | JWT Token
        Models.SocialMedia socmed = ; // Models.SocialMedia | Social Media Account
        try {
            models.SocialMedia result = apiInstance.socmedsPost(authorization, socmed);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling SocialMediaApi#socmedsPost");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Models.SocialMedia *socmed = ; // Social Media Account

SocialMediaApi *apiInstance = [[SocialMediaApi alloc] init];

// Create a new social media account
[apiInstance socmedsPostWith:authorization
    socmed:socmed
              completionHandler: ^(models.SocialMedia output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
var socmed = ; // {Models.SocialMedia} Social Media Account
...
api.socmedsPost(authorization, socmed, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class socmedsPostExample
    {
        public void main()
        {
            ...
            var apiInstance = new SocialMediaApi();
            var authorization = authorization_example;  // String | JWT Token
            var socmed = new Models.SocialMedia(); // Models.SocialMedia | Social Media Account
            ...
            {
                Debug.Print("Exception when calling SocialMediaApi.socmedsPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\SocialMediaApi();
$authorization = authorization_example; // String | JWT Token
$socmed = ; // Models.SocialMedia | Social Media Account

try {
    $result = $api_instance->socmedsPost($authorization, $socmed);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SocialMediaApi->socmedsPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SocialMediaApi;
...
my $api_instance = WWW::SwaggerClient::SocialMediaApi->new();
my $authorization = authorization_example; # String | JWT Token
my $socmed = WWW::SwaggerClient::Object::Models.SocialMedia->new(); # Models.SocialMedia | Social Media Account

eval { 
    my $result = $api_instance->socmedsPost(authorization => $authorization, socmed => $socmed);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling SocialMediaApi->socmedsPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-socmedsPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Create a new social media account
    api_response = api_instance.socmeds_post(authorization, socmed)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling SocialMediaApi->socmedsPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_socmedsPost_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                    ...
                    Required
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                <tr><td style="width:150px;">socmed <span style="color:red;">*</span></td>
<td>
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_socmedsPost_socmed');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_socmedsPost_socmed"></div>
</td>
</tr>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-socmedsPost-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-socmedsPost-200-schema">
                                  <div id='responses-socmedsPost-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = {
  "description" : "OK",
  "schema" : {
    "$ref" : "#/definitions/models.SocialMedia"
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-socmedsPost-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-socmedsPost-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-socmedsPost-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-SocialMedia-socmedsSocmedIdGet">
                      <article id="api-SocialMedia-socmedsSocmedIdGet-0" data-group="User" data-name="socmedsSocmedIdGet" data-version="0">
                        <div class="pull-left">
                          <h1>socmedsSocmedIdGet</h1>
                          <p>Get a social media account by ID</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        ...
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/socmeds/{socmedId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SocialMedia-socmedsSocmedIdGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SocialMedia-socmedsSocmedIdGet-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X GET "https://localhost:8080/api/v1/socmeds/{socmedId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
    ...
    public static void main(String[] args) {
        ...
        SocialMediaApi apiInstance = new SocialMediaApi();
        String authorization = authorization_example; // String | JWT Token
        Integer socmedId = 56; // Integer | Social Media ID
        try {
            apiInstance.socmedsSocmedIdGet(authorization, socmedId);
        } catch (ApiException e) {
            System.err.println("Exception when calling SocialMediaApi#socmedsSocmedIdGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">String *authorization = authorization_example; // JWT Token
Integer *socmedId = 56; // Social Media ID

SocialMediaApi *apiInstance = [[SocialMediaApi alloc] init];

// Get a social media account by ID
[apiInstance socmedsSocmedIdGetWith:authorization
    socmedId:socmedId
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
var socmedId = 56; // {Integer} Social Media ID
...
api.socmedsSocmedIdGet(authorization, socmedId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class socmedsSocmedIdGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling SocialMediaApi.socmedsSocmedIdGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\Api\SocialMediaApi();
$authorization = authorization_example; // String | JWT Token
$socmedId = 56; // Integer | Social Media ID

try {
    $api_instance->socmedsSocmedIdGet($authorization, $socmedId);
} catch (Exception $e) {
    echo 'Exception when calling SocialMediaApi->socmedsSocmedIdGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SocialMediaApi;
...
my $api_instance = WWW::SwaggerClient::SocialMediaApi->new();
my $authorization = authorization_example; # String | JWT Token
my $socmedId = 56; # Integer | Social Media ID

eval { 
    $api_instance->socmedsSocmedIdGet(authorization => $authorization, socmedId => $socmedId);
};
if ($@) {
    warn "Exception when calling SocialMediaApi->socmedsSocmedIdGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-socmedsSocmedIdGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Get a social media account by ID
    api_instance.socmeds_socmed_id_get(authorization, socmedId)
except ApiException as e:
    print("Exception when calling SocialMediaApi->socmedsSocmedIdGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_socmedsSocmedIdGet_socmedId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
<td>
    ...
    <div id="d2e199_socmedsSocmedIdGet_authorization">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    String
                ...
                <div class="inner required">
                    Required
                      ...
                      <hr>
                    <div id="api-SocialMedia-updateSocmed">
                      <article id="api-SocialMedia-updateSocmed-0" data-group="User" data-name="updateSocmed" data-version="0">
                        <div class="pull-left">
                          <h1>updateSocmed</h1>
                          <p>Update a social media profile</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Update a social media profile for the authenticated user</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/socmeds/{socmedId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-SocialMedia-updateSocmed-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-java">Java</a></li>
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-updateSocmed-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-SocialMedia-updateSocmed-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-php">PHP</a></li>
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-SocialMedia-updateSocmed-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-SocialMedia-updateSocmed-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X PUT "https://localhost:8080/api/v1/socmeds/{socmedId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
    ...
    public static void main(String[] args) {
        ...
        Models.SocialMedia socmed = ; // Models.SocialMedia | Social Media Account
        try {
            apiInstance.updateSocmed(socmedId, socmed);
        } catch (ApiException e) {
            System.err.println("Exception when calling SocialMediaApi#updateSocmed");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.SocialMediaApi;
...
public class SocialMediaApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *socmedId = 56; // Social media profile ID
Models.SocialMedia *socmed = ; // Social Media Account
...
[apiInstance updateSocmedWith:socmedId
    socmed:socmed
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.updateSocmed(socmedId, socmed, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class updateSocmedExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling SocialMediaApi.updateSocmed: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $api_instance->updateSocmed($socmedId, $socmed);
} catch (Exception $e) {
    echo 'Exception when calling SocialMediaApi->updateSocmed: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::SocialMediaApi;
...
eval { 
    $api_instance->updateSocmed(socmedId => $socmedId, socmed => $socmed);
};
if ($@) {
    warn "Exception when calling SocialMediaApi->updateSocmed: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-SocialMedia-updateSocmed-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Update a social media profile
    api_instance.update_socmed(socmedId, socmed)
except ApiException as e:
    print("Exception when calling SocialMediaApi->updateSocmed: %s\n" % e)</code></pre>
                            </div>
                          </div>
...
<td>
    ...
    <div id="d2e199_updateSocmed_socmedId">
        <div class="json-schema-view">
            <div class="primitive">
                <span class="type">
                    Integer
...
$(document).ready(function() {
  ...
  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
  var result = $('#d2e199_updateSocmed_socmed');
  result.empty();
  result.append(view.render());
});
</script>
<div id="d2e199_updateSocmed_socmed"></div>
</td>
</tr>
                ...
                <section id="api-Users">
                  <h1>Users</h1>
                    <div id="api-Users-usersLoginPost">
                      <article id="api-Users-usersLoginPost-0" data-group="User" data-name="usersLoginPost" data-version="0">
                        <div class="pull-left">
                          <h1>usersLoginPost</h1>
                          <p>Login a user</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Log in a user with the given credentials</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/users/login</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Users-usersLoginPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Users-usersLoginPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Users-usersLoginPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Users-usersLoginPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Users-usersLoginPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Users-usersLoginPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Users-usersLoginPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Users-usersLoginPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Users-usersLoginPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Users-usersLoginPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Users-usersLoginPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Users-usersLoginPost-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://localhost:8080/api/v1/users/login"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Users-usersLoginPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Users-usersLoginPost-0-android">
...
public class UsersApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Users-usersLoginPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Users-usersLoginPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">
UsersApi *apiInstance = [[UsersApi alloc] init];

// Login a user
[apiInstance usersLoginPostWithCompletionHandler: 
              ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-Users-usersLoginPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');

var api = new MyGramApi.UsersApi()
...
api.usersLoginPost(callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Users-usersLoginPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Users-usersLoginPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class usersLoginPostExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.usersLoginPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Users-usersLoginPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Users-usersLoginPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
...
if ($@) {
    warn "Exception when calling UsersApi->usersLoginPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Users-usersLoginPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Login a user
    api_instance.users_login_post()
except ApiException as e:
    print("Exception when calling UsersApi->usersLoginPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
                      ...
                      <hr>
                    <div id="api-Users-usersRegisterPost">
                      <article id="api-Users-usersRegisterPost-0" data-group="User" data-name="usersRegisterPost" data-version="0">
                        <div class="pull-left">
                          <h1>usersRegisterPost</h1>
                          <p>Register a new user</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Create a new user with the given details</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/users/register</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Users-usersRegisterPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Users-usersRegisterPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Users-usersRegisterPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Users-usersRegisterPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Users-usersRegisterPost-0-curl">
                            <pre class="prettyprint"><code class="language-bsh">curl -X POST "https://localhost:8080/api/v1/users/register"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Users-usersRegisterPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.UsersApi;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Users-usersRegisterPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.UsersApi;
...
public class UsersApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Users-usersRegisterPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Users-usersRegisterPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">
UsersApi *apiInstance = [[UsersApi alloc] init];

// Register a new user
[apiInstance usersRegisterPostWithCompletionHandler: 
              ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-Users-usersRegisterPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var MyGramApi = require('my_gram_api');
...
api.usersRegisterPost(callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Users-usersRegisterPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Users-usersRegisterPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class usersRegisterPostExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling UsersApi.usersRegisterPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Users-usersRegisterPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');
...
try {
    $api_instance->usersRegisterPost();
} catch (Exception $e) {
    echo 'Exception when calling UsersApi->usersRegisterPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Users-usersRegisterPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::UsersApi;
...
if ($@) {
    warn "Exception when calling UsersApi->usersRegisterPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Users-usersRegisterPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Register a new user
    api_instance.users_register_post()
except ApiException as e:
    print("Exception when calling UsersApi->usersRegisterPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
